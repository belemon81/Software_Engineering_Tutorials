...
export default class StudentAdd extends React.Component {
    ...
    handleSubmit = event => {
        ...
        // don't worry setState will run after rendering
        this.setState({
            name:'',
            age:''
        });
        ...
        return (
          <div className="container text-center mt-3 mb-5">
              ...
              <form className="form card p-3 bg-light" onSubmit={this.handleSubmit}>
                  ...
                  <input className="form-control" type="text" id="name" minLength="3" maxLength="20" required onChange={this.handleChange}/>
                  <label className="form-label h5 text-success">Student Age</label>
                  <input className="form-control" type="number" id="age" min="18" max="25" required onChange={this.handleChange}/>
